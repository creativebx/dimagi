...
function des_templater_actions_handler(action, value, des){
	...
	switch (value){
		...
		break;
		case "menu":
			opts = [des+"_menu_font", des+"_menu_font_size", des+"_menu_color", des+"_menu_selected_color", des+"_menu_background_color", des+"_menu_selected_background_color", des+"_menu_uppercase", des+"_menu_side_margin", des+"_big_menu_margin_top", des+"_big_menu_padding_bottom", des+"_small_menu_margin_top", des+"_small_menu_padding_bottom"];
		break;
		case "pagetitle":
