...
$colors = array('26ade4', '7AB317', 'F15A23', 'd63b33', 'e0aa16', 'FF005A', '9e4d9e', '5a7c96', '10b9b9', 'A9CA6E', '91683d', '3691ad');
...
array(
	"name" => "Selected Font Color",
	"id" => DESIGNARE_SHORTNAME."_menu_selected_color",
	"type" => "color",
	"std" => "FFFFFF"
),
...
array(
	...
	"type" => "color",
	"std" => "383838",
	"desc" => "This option will only be applied if the Header Style 4 is selected."
),

array(
	"name" => "Selected Background Color",
	"id" => DESIGNARE_SHORTNAME."_menu_selected_background_color",
	"type" => "color",
	"std" => "292828"
),
