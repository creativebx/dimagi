...
class DesignareOptionsManager{
	...
	function print_custom($value){
		...
		//if ($value['id'] != 'anya_reset_options_button')
		...
		echo '<script type="text/javascript">
			jQuery(document).ready(function($){
				...
				jQuery(\'#anya_export_options_button\').css({\'position\':\'relative\',\'float\':\'left\'}).attr(\'target\',\'_blank\').unbind().click(function(){
