...
class Testimonials_Widget extends WP_Widget {
	function Testimonials_Widget() {
		$widget_ops = array('classname' => 'testimonials_widget', 'description' => __('Show your testimonials on your site.','anya'));
		parent::WP_Widget(false, 'DESIGNARE _ Testimonials', $widget_ops);
	}
...
?>  
       ...
       <p><label for="<?php echo $this->get_field_id('nshow'); ?>">&#8212; <?php _e('Number Testimonials to show','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('nshow'); ?>" name="<?php echo $this->get_field_name('nshow'); ?>" type="text" value="<?php echo $nshow; ?>" /><br><span class="flickr-stuff">If 0 will show all testimonials.</span></label></p>
       <p><label for="<?php echo $this->get_field_id('scroller'); ?>">&#8212; <?php _e('Scroller','anya'); ?> &nbsp;<input id="<?php echo $this->get_field_id('scroller'); ?>" name="<?php echo $this->get_field_name('scroller'); ?>" type="checkbox" value="scroller" <?php if($scroller == "scroller") echo 'checked'; ?>/></label></p>
       ...
       <p><label for="<?php echo $this->get_field_id('hideauthor'); ?>">&#8212; <?php _e('Hide Author','anya'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hideauthor'); ?>" name="<?php echo $this->get_field_name('hideauthor'); ?>" type="checkbox" value="hideauthor" <?php if($hideauthor == "hideauthor") echo 'checked'; ?>/></p>
       <p><label for="<?php echo $this->get_field_id('hidecompany'); ?>">&#8212; <?php _e('Hide Company','anya'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hidecompany'); ?>" name="<?php echo $this->get_field_name('hidecompany'); ?>" type="checkbox" value="hidecompany" <?php if($hidecompany == "hidecompany") echo 'checked'; ?>/></label></p>  
...
function widget($args, $instance) {
	...
	if ($scroller == "yes" || $scroller == "scroller"){
		wp_enqueue_script( 'carrossel', DESIGNARE_JS_PATH .'jquery.jcarousel.min.js', 'jquery','1.0', false);
		$aux = 1;
		...
		if ($title != ""){
		 	...
		 	<section class="recent_projects recent_testimonials">
		 		<div class="anyatitle page_title_testimonials">
			 		<span class="page_info_title_testimonials wdgt-test">'.$title.'</span>
			 		<hr>
	   	...
	   	$r .= '
		  	<div id="testimonials2" class="deswidget home_proj slideContent testimonis-'.$randid.'"><ul class="carousel">';
		...
		if ($title != ""){
			$r = '
		 	<section class="recent_projects recent_testimonials"><div class="anyatitle page_title_testimonials"><hr><span class="page_info_title_testimonials wdgt-test">'.$title.'</span></div>';	
		} else {
			$r = '
		 	<section class="recent_projects recent_testimonials">';
		}
