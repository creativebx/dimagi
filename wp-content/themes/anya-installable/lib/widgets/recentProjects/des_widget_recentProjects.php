...
class Projects_Widget extends WP_Widget {
	function Projects_Widget() {
		$widget_ops = array('classname' => 'projects_widget', 'description' => __('Show your Projects on your site.','anya'));
		parent::WP_Widget(false, 'DESIGNARE _ Projects', $widget_ops);
	}
	function form($instance) {
       ...
       <!-- NEW -->
       <p>
	        <label>&#8212; <?php _e('Projects Style','anya'); ?> &#8212;<br>
       ...
       <p><label for="<?php echo $this->get_field_id('portfolio'); ?>">&#8212; <?php _e('Portfolios','anya'); ?> &#8212;<input style="display:none;" class="widefat" id="<?php echo $this->get_field_id('portfolio'); ?>" name="<?php echo $this->get_field_name('portfolio'); ?>" type="text" value="<?php echo $portfolio; ?>" ></label></p>
       <div class="widget-portfolio-categories">
	       <?php
			...
			} else { ?> <i style="position:relative;top:-8px;margin-left:15px;"> <?php _e("No Portfolios defined.", "anya"); ?></i> <?php }
	       ?>
       </div>
       
       <p><label for="<?php echo $this->get_field_id('nshow'); ?>">&#8212; <?php _e('Number Projects to show','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('nshow'); ?>" name="<?php echo $this->get_field_name('nshow'); ?>" type="text" value="<?php echo $nshow; ?>" /><br><span class="flickr-stuff">If 0 will show all projects.</span></label></p>
       <p class="scroller_select"><label for="<?php echo $this->get_field_id('scroller'); ?>">&#8212; <?php _e('Scroller','anya'); ?> &nbsp;<input id="<?php echo $this->get_field_id('scroller'); ?>" name="<?php echo $this->get_field_name('scroller'); ?>" type="checkbox" value="scroller" <?php if($scroller == "scroller") echo 'checked'; ?> onchange="if (!jQuery(this).is(':checked')) jQuery(this).closest('p').next().show(); else jQuery(this).closest('p').next().hide();" /></label></p>
       
       <!-- NEW -->
       <p><label>&#8212; <?php _e('Project per Row','anya'); ?> &#8212;</label><br>
       ...
       <!-- NEW -->
       <p><label for="<?php echo $this->get_field_id('categories'); ?>">&#8212; <?php _e('Categories','anya'); ?> &#8212;</label><input style="display:none;" class="widefat" id="<?php echo $this->get_field_id('categories'); ?>" name="<?php echo $this->get_field_name('categories'); ?>" type="text" value="<?php echo $categories; ?>" ></p>
	   ...
	   <p><label>&#8212; <?php _e('Order by','anya'); ?> &#8212;</label><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('orderby'); ?>" value="title" <?php if($orderby == 'title') echo 'checked'; ?>> <?php _e('Title','anya'); ?><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('orderby'); ?>" value="date" <?php if($orderby == 'date') echo 'checked'; ?>> <?php _e('Date','anya'); ?><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('orderby'); ?>" value="author" <?php if($orderby == 'author') echo 'checked'; ?>> <?php _e('Author','anya'); ?><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('orderby'); ?>" value="comment_count" <?php if($orderby == 'comment_count') echo 'checked'; ?>> <?php _e('Number Comments','anya'); ?><br>
	    </p>
	    <p><label>&#8212; <?php _e('Order','anya'); ?> &#8212;</label><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('order'); ?>" value="asc" <?php if($order == 'asc') echo 'checked'; ?>> <?php _e('Ascending','anya'); ?><br>
    		<input style="margin-left:15px;" type="radio" name="<?php echo $this->get_field_name('order'); ?>" value="desc" <?php if($order == 'desc') echo 'checked'; ?>> <?php _e('Descending','anya'); ?><br>
	    </p>
		...
		if ($style == "1"){
			...
			if ($scroller == "yes"){
				...
				if ($link_to_projects != ""){
					...
					if ($title != ""){
						$output .= '<section id="lastprojects3-'.$randID.'" class="home_widget recentProjects3"><div class="projects_container_proj"><div class="anyatitle page_title_s3"><span class="page_info_title_s3">'. $title . '</span></div><hr><div class="project_list_s3"><div class="slides_container jcarousel-skin-tango">'.$individual_project.'</div></div></div><div class="clear"></div></section>';
					} else {
