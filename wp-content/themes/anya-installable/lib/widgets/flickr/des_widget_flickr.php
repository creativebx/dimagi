...
class Flickr_Widget extends WP_Widget {
	function Flickr_Widget() {
		$widget_ops = array('classname' => 'flickr_widget', 'description' => __('Show your flickr photos on your site.','anya'));
		parent::WP_Widget(false, 'DESIGNARE _ Flickr Photos', $widget_ops);
	}
...
?>  
       ...
       <p><label for="<?php echo $this->get_field_id('flickrid'); ?>">&#8212; <?php _e('Flickr ID','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('flickrid'); ?>" name="<?php echo $this->get_field_name('flickrid'); ?>" type="text" value="<?php echo $flickrid; ?>" /></label></p>
       <p><label for="<?php echo $this->get_field_id('nphotos'); ?>">&#8212; <?php _e('Number Photos to show','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('nphotos'); ?>" name="<?php echo $this->get_field_name('nphotos'); ?>" type="text" value="<?php echo $nphotos; ?>" /><br><span class="flickr-stuff">If 0 will show 20 photos.</span></label></p>
