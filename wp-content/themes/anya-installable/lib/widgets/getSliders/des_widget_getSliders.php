...
class GetSliders_Widget extends WP_Widget {
	...
	function GetSliders_Widget() {
		$widget_ops = array('classname' => 'getSliders_widget', 'description' => __('Show the sliders you have created.','anya'));
		parent::WP_Widget(false, 'DESIGNARE _ My Sliders', $widget_ops);
	}
	...
	function form($instance) {
       ...
       ?>
		    ...
		    <p><label for="<?php echo $this->get_field_id('title'); ?>">&#8212; <?php _e('Slider Title','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /><br></label></p> 
		    <p>
		    <p><label for="<?php echo $this->get_field_id('speed'); ?>">&#8212; <?php _e('Transition Speed','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('speed'); ?>" name="<?php echo $this->get_field_name('speed'); ?>" type="text" value="<?php echo $speed; ?>" /><br><span class="flickr-stuff">In milliseconds.</span></label></p> 
		    <p>
		    <p><label for="<?php echo $this->get_field_id('interval'); ?>">&#8212; <?php _e('Slides Duration','anya'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('interval'); ?>" name="<?php echo $this->get_field_name('interval'); ?>" type="text" value="<?php echo $interval; ?>" /><br><span class="flickr-stuff">In milliseconds.</span></label></p> 
		    <p>
		    <p>
		        <label>&#8212; <?php _e('Autoplay','anya'); ?> &#8212;<br>
		    ...
		    <p>
		        <label>&#8212; <?php _e('Direction Arrows','anya'); ?> &#8212;<br>
