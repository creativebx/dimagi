...
<div class="alignleft"><?php if (!function_exists('icl_object_id')) previous_posts_link('<span>&laquo;</span> '.des_text('_previous_text')); else previous_posts_link('<span>&laquo;</span> '.__('Older Entries','anya')); ?></div>
<div class="alignright"><?php if (!function_exists('icl_object_id')) next_posts_link(des_text('_next_text').' <span>&raquo;</span>'); else next_posts_link(__('Newer Entries','anya').' <span>&raquo;</span>'); ?></div>
</div>
	<?php
	}
}
