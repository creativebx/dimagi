...
array('id'=>'buttonstyle', 'type'=>'select-color', 'options' => array(array('value' => 'black', 'name' => 'Black'), array('value' => 'white', 'name' => 'White'), array('value' => 'yellow', 'name' => 'Yellow'), array('value' => 'orange', 'name' => 'Orange'), array('value' => 'red', 'name' => 'Red'), array('value' => 'green', 'name' => 'Green'), array('value' => 'blue', 'name' => 'Blue'), array('value' => 'violet', 'name' => 'Violet'), array('value' => 'greenanya', 'name' => 'GreenAnya')), 'name'=>'Button Style'),
...
function dimagi_get_color_palette_colors () {
