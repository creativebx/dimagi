	...
	global $designare_data, $designare_new_meta_boxes, $designare_new_meta_portfolio_boxes, $new_meta_testimonials_boxes, $designare_new_meta_post_boxes, $new_meta_partners_boxes, $new_meta_team_boxes, $designare_new_meta_box_des_templater;
		...
		array(
			/*array(
				...
				"type" => "text",
				"std" => "",
				"description" => "If set, will display a second title below the main one (if available). If you need to use classes use <strong style=\"font-style:normal;\">'</strong> instead of <strong style=\"font-style:normal;\">\"</strong>. You can also use <strong style=\"font-style:normal;\">br</strong> tags."
			),*/
			...
			array(
				...
				"type" => "text",
				"std" => "",
				"description" => "If set, will display lead text below the title of the page."
			),
			...
			array(
				...
				"std" => "",
				"options" => array(
				    array("name"=>"Top", "id"=>"header-position-top"),
				    array("name"=>"Middle", "id"=>"header-position-middle"),
				    array("name"=>"Bottom", "id"=>"header-position-bottom")
                ),
				"description" => ""
			),

			array(
				"title" => "Header Image Y-Offest",
				"name" => "headerImageY",
				"type" => "text",
				"std" => "",
				"description" => "Overrides Header Image Alignment. The Y-offset of the header Image (negative or positive). Please specify a unit eg: 60% (preferable) or -140px"
			),
			...
			array(
				...
				"type" => "text",
				"std" => "",
				"description" => "format like title,anchor-id;"
			),

			array(
				"title" => "Page Color",
				"name" => "pageCustomColor",
				"type" => "select",
				"std" => "",
				"options" => array(
				    array("name"=>"Brand Primary (Orange)", "id"=>"color-brand-primary"),
				    array("name"=>"Brand Secondary (Blue)", "id"=>"color-brand-secondary"),
				    array("name"=>"Neutral", "id"=>"color-neutral"),
				    array("name"=>"Cool Light Accent (Turquoise)", "id"=>"color-cool-light-accent"),
				    array("name"=>"Cool Dark Accent (Purple)", "id"=>"color-cool-dark-accent"),
				    array("name"=>"Attention Positive (Green)", "id"=>"color-attn-pos"),
				    array("name"=>"Attention Negative (Red)", "id"=>"color-attn-neg"),
				    array("name"=>"Warm Light Accent (Gold)", "id"=>"color-warm-light-accent")
                ),
				"description" => "Choose the page color from the palette."
			),

			array(
				"title" => '<div class="ui-icon ui-icon-image no_show_hide_opts"></div>Team Profile Settings - available only for Team Page Profiles',
				"type" => "heading",
				"name" => "",
				"std" => "",
				"description" => ""
			...
			array (
				...
				"old_key" => true,
				"std" => "",
				"description" => "URL to staff photo Image"
			),
			...
			array (
				...
				"old_key" => true,
				"std" => "",
				"description" => "Wordpress username for staff member (will pull up primary author posts of this person on the page)"
			),
			...
			array(
				...
				"description" => "You can see a preview of the different header types on <strong>Appearance > Anya Options > Style Options > Header</strong>"
			),
...
function create_meta_team_box() {
	if ( function_exists('add_meta_box') ) {
	    add_meta_box( 'new-meta-box-des-templater', '<div class="icon-small"></div> '.DESIGNARE_THEMENAME.' DESIGNARE TEMPLATER', 'designare_new_meta_box_des_templater', DESIGNARE_TEAM_POST_TYPE, 'normal', 'high' );
...
function print_meta_box($meta_box, $post){
	...
	if ( array_key_exists ( 'old_key', $meta_box ) ) {
