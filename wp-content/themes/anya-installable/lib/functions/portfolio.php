...
function designare_register_portfolio_post_type() {
	...
	$labels = array(
		    'name' => _x('Projects', 'portfolio name','anya'),
		    'singular_name' => _x('Project Item', 'portfolio type singular name','anya'),
		    'add_new' => __('Add New','anya'),
		    'add_new_item' => __('Add New Item','anya'),
		    'edit_item' => __('Edit Item','anya'),
		    'new_item' => __('New Project Item','anya'),
		    'view_item' => __('View Item','anya'),
		    'search_items' => __('Search Project Items','anya'),
		    'not_found' =>  __('No project items found','anya'),
		    'not_found_in_trash' => __('No project items found in Trash','anya'), 
		    'parent_item_colon' => ''
		    );
