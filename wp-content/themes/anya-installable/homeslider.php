<?php
	...
	if ($slidertype != "no_slider"){
		...
		if (substr($slidertype, 0, 10) === "revSlider_"){
            ...
            ?>
                <div class="lead-container lead-container-home<?php
		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function($){
				...
				var styleColor = "<?php global $anya_styleColor; echo $anya_styleColor; ?>"; 
				/* slideshow */
				...
				if ($('#slider_container').length){
					...
					$('#slider_container').camera({
						...
						loaderPadding: 0,
						loaderOpacity: .6,
						loaderColor: '<?php global $anya_styleColor; echo $anya_styleColor; ?>',
							...
							jQuery(document).ready(function() {
								jQuery('#myslider-<?php echo $randID; ?>').flexslider({
									...
									start: function(slider) {
										jQuery('#myslider-<?php echo $randID; ?>').find(".flex-direction-nav").click(function(){
											window.location = jQuery('#myslider-<?php echo $randID; ?> .slides li').eq(slider.currentSlide<?php echo $plus1; ?>).children("a").attr("href"); 
										});
