...
*/
	...
	$('.dl-menu a').each(function(){ 
		if ($(this).siblings('ul').length){
			$(this).after('<span class="gosubmenu rfa fa-angle-right" />');
		}
	...
	if ($('#lang_sel a.lang_sel_sel, #lang_sel_click a.lang_sel_sel').length){
		$('#lang_sel a.lang_sel_sel, #lang_sel_click a.lang_sel_sel').append('<i class="fa fa-caret-down"></i>');
		...
		if ($('.logo_and_menu .logo a img').length){
			...
			if ($('#headerType').html() === "without"){
			    ...
			    image.onload = function(){
					...
					$('.flexslider_container').css('padding-top', newHeight+60 +'px');
