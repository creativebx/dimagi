            ...
            if (!isMobile.any() && $('#disable_responsive_layout').html() == "off"){
	         	$(window).resize(function(){
		            ...
		            if (env.widget){
			            ...
			            if (env.$elts.carousel.closest('.wpb_column').hasClass('vc_span6')){
				            env.$elts.content.children().each(function(){
					            if (windowWidth < 480)
				            		$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span6').outerWidth())-5));
				            	else
					            	$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span6').outerWidth() / 2)-5));
				            });
				            columns = true;
			            }
			            if (env.$elts.carousel.closest('.wpb_column').hasClass('vc_span4')){
				            env.$elts.content.children().each(function(){
					            if (windowWidth < 768 && windowWidth > 480){
						            $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span4').outerWidth() / 2)-5));   
					            } else {
						            $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span4').outerWidth())-5));
					            }
				            });
				            columns = true;
			            }
			            if (env.$elts.carousel.closest('.wpb_column').hasClass('vc_span8')){
				            env.$elts.content.children().each(function(){
					         	if (windowWidth < 480)
				            		$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span8').outerWidth())-5));
				            	else {
						            $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span8').outerWidth() / 2)-5));
						            if ($(this).closest('section').is('.recentProjects3')){
					            		$(this).width($(this).width()-5);
							        }
						        }
			            ...
			            if (env.$elts.carousel.closest('.wpb_column').hasClass('vc_span3')){
				            env.$elts.content.children().each(function(){
			            		$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span3').outerWidth())-5));
				            });
				            columns = true;
			            }
			            
			            if (env.$elts.carousel.closest('.wpb_column').hasClass('vc_span9')){
				            env.$elts.content.children().each(function(){
				            	if (env.$elts.carousel.closest('section').is('.recentProjects4')){
					            	if (windowWidth < 480)
					            		$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth())-5));
					            	if (windowWidth < 768 && windowWidth > 479)
							            $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 2)-5));
							        if (windowWidth > 767 && windowWidth < 960)
								        $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 3)-5));
							        if (windowWidth > 959)
							        	$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 3)-5));	
				            	} else {
					            	if (windowWidth < 480)
					            		$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth())-10));
					            	if (windowWidth < 768 && windowWidth > 479)
							            $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 2)-10));
							        if (windowWidth > 767 && windowWidth < 960)
								        $(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 3)-10));
							        if (windowWidth > 959)
							        	$(this).css('width', Math.floor((env.$elts.carousel.closest('.vc_span9').outerWidth() / 3)-10));	
				            	}
				            });
