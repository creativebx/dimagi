...
<iframe src=\"http://www.facebook.com/plugins/like.php?href=" . $url . "&amp;layout=" . $style . "&amp;show_faces=" . $showfaces . "&amp;width=" . $width . "&amp;action=" . $verb . "&amp;colorscheme=" . $colorscheme . "&amp;font=" . $font . "\" scrolling=\"no\" allowTransparency=\"true\" style=\"border:none; overflow:hidden; width:" . $widthpx . "; height:" . $height . "px;\"></iframe>
</div>
	";
	return $output;
...
function des_shortcode_toggle ( $atts, $content = null ) {
		...
		$defaults = array(
							'title_open' => __( 'Hide the Content', 'anya' ),
							'title_closed' => __( 'Show the Content', 'anya' ),
							'hide' => 'yes',
							'display_main_trigger' => 'yes',
							'excerpt_length' => '0',
							'include_excerpt_html' => 'no',
							'read_more_text' => __( 'Read More', 'anya' ),
							'read_less_text' => __( 'Read Less', 'anya' )
						);
...
function des_shortcode_contactform ( $atts, $content = null ) {
		...
		return "<div class=\"contact-form\">
				...
				<form method=\"post\" action=\"#\" class=\"validateform\">
					<ul class=\"forms\">
						<li>
							<label>" . __(get_option(DESIGNARE_SHORTNAME.'_cf_name'), "anya") . "</label><input type=\"text\" name=\"name\" class=\"yourname txt corner-input\" onfocus=\"checkerror(this)\" onblur=\"var v = $(this).val(); $('.yourname_val').html(v);\">
							<div class=\"yourname_val\" style=\"display:none\"></div>
						</li>
						<li>
							<label>" . __(get_option(DESIGNARE_SHORTNAME.'_cf_email'), "anya") . "</label><input style=\"margin: 10px 0;\" type=\"text\" name=\"email\" class=\"youremail txt corner-input\" onfocus=\"checkerror(this)\" onblur=\"var v = $(this).val(); $('.youremail_val').html(v);\">
							<div class=\"youremail_val\" style=\"display:none\"></div>
						</li>
						<li>
							<label>" . __(get_option(DESIGNARE_SHORTNAME.'_cf_message'), "anya") . "</label><textarea name=\"message\" class=\"yourmessage textarea message corner-input\" rows=20 cols=30 onfocus=\"checkerror(this)\" onblur=\"var v = $(this).val(); $('.yourmessage_val').html(v);\"></textarea>
							<div class=\"yourmessage_val\" style=\"display:none\"></div>
						</li>
						<li>
							<a id=\"send-comment\" href=\"javascript:;\" onclick=\"sendemail($(this),\'".$e."\', \'".$subject."\', \'".$name_error."\', \'".$email_error."\', \'".$message_error."\', \'".$success_message."\', \'".$unsuccess_message."\');\" class=\"submit\">" . __(get_option(DESIGNARE_SHORTNAME.'_cf_send'), "anya") . "</a>
						</li>
					</ul>
				</form>
			</div>";
...
function des_shortcode_rp_style1 ( $atts, $content = null ) {
		...
		if ($scroller == "yes"){
			if ($link_to_projects != ""){
				$output .= "<section id=\"lastprojects3-".$randID."\" class=\"home_widget recentProjects3\"><div class=\"projects_container_proj\"><div class=\"anyatitle page_title_s3\"><span class=\"page_info_title_s3\">". $title . "</span><div class=\"pag-proj2_s3\"><div class=\"nextbutton carousel-control next carousel-next jcarousel-next jcarousel-next-horizontal\"></div><div class=\"goto_projects\"  onclick=\"window.location = '".$link_to_projects."';\" title=\"".$title_to_projects_link."\"></div><div class=\"prevbutton carousel-control previous carousel-previous jcarousel-prev jcarousel-prev-horizontal\"></div></div></div><div class=\"project_list_s3\" ><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script>jQuery(document).ready(function(){jQuery(\"#lastprojects3-".$randID." .slides_container\").parent().carousel({dispItems: 1".$autoplay_output."});});</script><div class=\"clear\"></div></section>";	
			} else {
				$output .= "<section id=\"lastprojects3-".$randID."\" class=\"home_widget recentProjects3\"><div class=\"projects_container_proj\"><div class=\"anyatitle page_title_s3\"><span class=\"page_info_title_s3\">". $title . "</span><div class=\"pag-proj2_s3\"><div class=\"nextbutton carousel-control next carousel-next jcarousel-next jcarousel-next-horizontal\"></div><div class=\"prevbutton carousel-control previous carousel-previous jcarousel-prev jcarousel-prev-horizontal\" ></div></div></div><div class=\"project_list_s3\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script>jQuery(document).ready(function(){jQuery(\"#lastprojects3-".$randID." .slides_container\").parent().carousel({dispItems: 1".$autoplay_output."});});</script><div class=\"clear\"></div></section>";
			}	
		} else {
			if ($link_to_projects != ""){
				$output .= "<section id=\"lastprojects3-".$randID."\" class=\"home_widget recentProjects3\"><div class=\"projects_container_proj\"><div class=\"anyatitle page_title_s3\"><span class=\"page_info_title_s3\">". $title . "</span><div class=\"pag-proj2_s3\"><div class=\"goto_projects\"  onclick=\"window.location = '".$link_to_projects."';\" title=\"".$title_to_projects_link."\"></div></div></div><div class=\"project_list_s3\"><div class=\"slides_container jcarousel-skin-tango\">".$individual_project."</div></div></div><div class=\"clear\"></div></section>";	
			} else {
				if ($title != ""){
					$output .= "<section id=\"lastprojects3-".$randID."\" class=\"home_widget recentProjects3\"><div class=\"projects_container_proj\"><div class=\"anyatitle page_title_s3\"><span class=\"page_info_title_s3\">". $title . "</span></div><div class=\"project_list_s3\"><div class=\"slides_container jcarousel-skin-tango\">".$individual_project."</div></div></div><div class=\"clear\"></div></section>";
				} else {
...
function des_shortcode_rp_style2 ( $atts, $content = null ) {
		...
		for($i=0; $i < count($projects_ids); $i++){
			...
			$s_categories .= "<span><p>".$cat_name."</p></span>";
			$s_categories .= "</span>";					
	
			$individual_project .= "\" />";
			
			$individual_project .= "<div class=\"dahover\"><span class=\"da-title\"><p>". $this_project->post_title. "</p></span>".$s_categories ."</div>";
		...
		if ($scroller == "yes"){
			if ($link_to_projects != ""){
				$output = "<section id=\"lastprojects4-".$randID."\" class=\"home_widget recentProjects4\"><div class=\"projects_container_s4\"><div class=\"anyatitle page_title_s4\"><span class=\"page_info_title_s4\">".$title."</span>";
				if ($title != "") $output .= "";
				$output .= "<div class=\"pag-proj2_s4\"><div class=\"nextbutton carousel-control next carousel-next jcarousel-next jcarousel-next-horizontal\"></div><div class=\"prevbutton carousel-control previous carousel-previous jcarousel-prev jcarousel-prev-horizontal\"></div></div></div><div class=\"project_list_s4\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div>";
				$output .= "<script>jQuery(document).ready(function(){ jQuery(\"#lastprojects4-".$randID." .da-thumbs > li > a > .post-thumb\").hoverdir(); jQuery(\"#lastprojects4-".$randID." .project_list_s4\").carousel({dispItems:1".$autoplay_output."});});</script>";
				$output .= "<div class=\"clear\"></div></div></section>";
			} else {
				$output = "<section id=\"lastprojects4-".$randID."\" class=\"home_widget recentProjects4\"><div class=\"projects_container_s4\"><div class=\"anyatitle page_title_s4\"><span class=\"page_info_title_s4\">".$title."</span>";
				if ($title != "") $output .= "";
				$output .= "<div class=\"pag-proj2_s4\"><div class=\"nextbutton carousel-control next carousel-next jcarousel-next jcarousel-next-horizontal\"></div><div class=\"prevbutton carousel-control previous carousel-previous jcarousel-prev jcarousel-prev-horizontal\"></div></div></div><div class=\"project_list_s4\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script type=\"text/javascript\"> jQuery(document).ready(function(){ jQuery(\"#lastprojects4-".$randID." .da-thumbs > li > a > .post-thumb\").hoverdir(); jQuery(\"#lastprojects4-".$randID." .project_list_s4\").carousel({dispItems: 1".$autoplay_output."}); });</script><div class=\"clear\"></div></section>";
			}	
		} else {
			if ($link_to_projects != ""){
				$output = "<section id=\"lastprojects4-".$randID."\" class=\"home_widget recentProjects4\"><div class=\"projects_container_s4\"><div class=\"anyatitle page_title_s4\"><span class=\"page_info_title_s4\">".$title."</span>";
				if ($title != "") $output .= "";
				$output .= "<div class=\"pag-proj2_s4\"><div class=\"goto_projects\" onclick=\"window.location = '".$link_to_projects."';\" title=\"".$title_to_projects_link."\"></div></div></div><div class=\"project_list_s4\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script type=\"text/javascript\"> jQuery(document).ready(function(){ jQuery(\"#lastprojects4-".$randID." .da-thumbs > li > a > .post-thumb\").hoverdir(); });</script><div class=\"clear\"></div></section>";
			} else {
				if ($title == ""){
					$output = "<section id=\"lastprojects4-".$randID."\" class=\"home_widget recentProjects4\"><div class=\"projects_container_s4\"><div class=\"project_list_s4\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script type=\"text/javascript\"> jQuery(document).ready(function(){ jQuery(\"#lastprojects4-".$randID." .da-thumbs > li > a > .post-thumb\").hoverdir(); });</script><div class=\"clear\"></div></section>";
				} else {
					$output = "<section id=\"lastprojects4-".$randID."\" class=\"home_widget recentProjects4\"><div class=\"projects_container_s4\"><div class=\"page_title_s4 a-left\"><span class=\"page_info_title_s4\">".$t."</span></div><div class=\"project_list_s4\"><ul class=\"slides_container jcarousel-skin-tango\">".$individual_project."</ul></div></div><script type=\"text/javascript\"> jQuery(document).ready(function(){ jQuery(\"#lastprojects4-".$randID." .da-thumbs > li > a > .post-thumb\").hoverdir(); });</script><div class=\"clear\"></div></section>";	
				}
			}
		}
...
*/
		...
		if ($scroller == "yes"){
			...
			if ($link_to_blog != ""){
				...
				return "<section id=\"recentPosts-" . $randID . "\" class=\"home_widget recentPosts_style2\"><div class=\"projects_container rposts2 sixteen columns\"><div class=\"anyatitle page_title_s2 \"><span class=\"page_info_title_s2\">". $title . "</span></div><div class=\"project_list_s2_style2\"><div class=\"slides_container post_listing jcarousel-skin-tango\">".$postes."</div></div></div><div class=\"clear\"></div></section>";
			}
		}
...
function des_shortcode_custom_slider ( $atts, $content = null ) {
		...
		return "<div id=\"myslider-".$randID."\" class=\"flexslider clearfix\" style=\"max-height:".$height.";\"><ul class=\"slides\">".$li."</ul></div><script type=\"text/javascript\">jQuery(document).ready(function($){ jQuery(\"#myslider-".$randID."\").flexslider({ animation: \"".$effect."\", slideDirection: \"vertical\",directionNav: ".$navigation.",slideshowSpeed: ".$speed.", controlsContainer: \"#myslider-".$randID." .flex-container\",pauseOnAction: false,pauseOnHover: ".$pause_on_hover.",keyboardNav: false,controlNav: ".$control_navigation.", start: function(slider) { jQuery(slider).find(\"li\").each(function(){ if (jQuery(this).children(\"a\").attr(\"href\") != \"javascript:;\"){jQuery(this).children(\"a\").children(\"img\").click(function(){window.location = jQuery(this).parent(\"a\").attr(\"href\");jQuery(this).parent(\"a\").attr(\"href\",\"javascript:;\");});}}); jQuery(\"#myslider-".$randID." .slides li\").eq(slider.currentSlide".$plus1.").find(\".flex-caption\").animate({\"opacity\" : 1}, 500);}, after: function(slider) { jQuery(\"#myslider-".$randID."\").find(\".flex-direction-nav\").click(function(){ window.location = jQuery(\"#myslider-".$randID." .slides li\").eq(slider.currentSlide".$plus1.").children(\"a\").attr(\"href\"); });  jQuery(\"#myslider-".$randID." .slides li\").find(\".flex-caption\").each(function(){jQuery(this).css(\"opacity\", 0); if(jQuery(this).parent().hasClass(\"clone\")){} else {jQuery(this).animate({\"opacity\" : 0}, 500);}});jQuery(\"#myslider-".$randID." .slides li\").eq(slider.currentSlide".$plus1.").find(\".flex-caption\").animate({\"opacity\" : 1}, 500);}}); });</script>";
...
function des_shortcode_tabs ( $atts, $content = null ) {
		...
		if ( count( $tab_titles ) ) {
			...
			$thetitle = "";
			if ( $title ) {
				$thetitle = "<div class=\"anyatitle\"><hr/><span>".$title."</span></div>";
			}
...
function des_shortcode_special_tabs($atts, $content = null){
	...
	if ($title!= ""){
		$output = "<div class=\"anyatitle title\">".$title."</div>";
	} 
...
function des_shortcode_accordion ( $atts, $content = null ) {
		...
		if ($title != ""){
			$titles_html = "<div class=\"anyatitle\"><span>".$title."</span><hr/></div>";
		}
...
function des_shortcode_team ( $atts, $content = null ) {
	...
	if ($scroller == "yes"){
		wp_enqueue_script( 'carrossel', DESIGNARE_JS_PATH .'jquery.jcarousel.min.js', array(),'1.0',$in_footer = true);
		$output .= "<div class=\"team_header anyatitle\"><span>" . $title . "</span><div class=\"pag-proj_team\">
		...
		if ($title != "")
			$output .= "<h2 class=\"team_header anyatitle sixteen columns\" style=\"min-height:20px;\"><span>" .  $title  . "</span></h2>";
	}
...
function des_shortcode_yvideo ( $atts, $content = null ) {
	...
	return "<div class=\"video-wrapper\"><iframe src=\"http://www.youtube.com/embed/" . $id . "?&amp;wmode=transparent".$rel."\" " . $style . "></iframe></div>";
...
function des_shortcode_vvideo ( $atts, $content = null ) {
	...
	return "<div class=\"video-wrapper\"><iframe src=\"http://player.vimeo.com/video/" . $id . "\" " . $style . "></iframe></div>";
...
function des_shortcode_testimonials ( $atts, $content = null ) {
	...
	if (empty($nshow) || $nshow == 0 || !$nshow) $nshow = -1;
	//else $nshow++;
	...
	if ($scroller == "yes" || $scroller == "scroller"){
		wp_enqueue_script( 'carrossel', DESIGNARE_JS_PATH .'jquery.jcarousel.min.js', array(),'1.0',$in_footer = true);
		$aux = 1;
		...
		if ($title != ""){
		 	...
		 	<section class=\"recent_projects recent_testimonials\" id=\"testimonials-".$testimonial_section_id."\">
		 		<div class=\"anyatitle page_title_testimonials\">
		  ...
		  if (!function_exists('icl_object_id')){
			  foreach($testi as $t){
		  		...
		  		$r .= "<div class=\"testi-text\">
		      		<p> " . $t->post_content . "</p><span class=\"testimonial-triangle\"></span>
		      	</div>";
		      	...
		      	$r .= "<div class=\"testi-info\">";
		      		
		      			if($hideauthor != "yes" && get_post_meta($t->ID, "author_value", true) != ""){
		      			...
		      			//if($hideauthor != "yes" && $hidecompany != "yes" && get_post_meta($t->ID, "company_value", true) != "") $r .= ", ";
		      			if($hidecompany != "yes" && get_post_meta($t->ID, "company_value", true) != ""){
			  ...
			  //else {
			  	//$nshow++;
				//  $query = "SELECT element_id FROM ".$table_prefix."icl_translations WHERE language_code = '".ICL_LANGUAGE_CODE."' AND element_type='post_testimonials' LIMIT 0,".$nshow;
			  //}
			  ...
			  if ($nshow > 0){
				foreach($results as $res){
			  	  if ($resindex < $nshow && get_post( $res['element_id'] ) != NULL ){
				  	  	$resindex++;
				  ...
				  foreach($results as $res){
				  	  if (get_post( $res['element_id'] ) != NULL ){
						  	array_push($testemunhos, get_post( $res['element_id'] ));	  
				  	  }
			  	 }	
			  }
		...
		if ($title != ""){
			$r = "
		 	<section class=\"recent_projects recent_testimonials\" id=\"testimonials-".$testimonial_section_id."\"><div class=\"anyatitle page_title_testimonials\"><span class=\"page_info_title_testimonials\">".$title."</span></div>";	
		} else {
			$r = "
		 	<section class=\"recent_projects recent_testimonials\" id=\"testimonials-".$testimonial_section_id."\">";
		}
...
function des_shortcode_typography ( $atts, $content = null ) {
	...
	global $anya_google_fonts;

	// Get just the names of the Google fonts.
	$google_font_names = array();

	if ( count( $anya_google_fonts ) ) {

		foreach ( $anya_google_fonts as $g ) {
...
function des_shortcode_socialicon ( $atts, $content = null ) {
	...
	if ( $profile_type != '' ) {
		...
		if ( $title ) { $_alt_text = $title; } else { $_alt_text = ucwords( $_profile_to_display ); $_alt_text = sprintf( __( 'My %s Profile', 'anya' ), $_alt_text ); } // End IF Statement
	...
	if ( $url == 'feed' ) {
		...
		if ( $title ) { $_alt_text = $title; } else { $_alt_text = __( 'Subscribe to our RSS feed', 'anya' ); } // End IF Statement
		...
		foreach ( $_supported_profiles as $k => $v ) {
			...
			if ( $host == $v ) {
				...
				if ( $title ) { $_alt_text = $title; } else { $_alt_text = ucwords( $matches[1] ); $_alt_text = sprintf( __( 'My %s Profile', 'anya' ), $_alt_text ); } // End IF Statement
...
function des_shortcode_twitter_follow ( $atts, $content = null ) {
	...
	$output = "<div class=\"shortcode-twitter-follow" . $allowed_floats[$float] . "\"><a href=\"http://twitter.com/" . $username . "/\"" . $tag_atts . " class=\"twitter-follow-button\">" . __( 'Follow', 'anya' ) . " " . $username . "</a></div>" . "\n";
...
/*-----------------------------------------------------------------------------------*/
/* 27. Heading Text [heading_text style=""][/heading_text]
/*-----------------------------------------------------------------------------------*/

function des_shortcode_headings( $atts, $content = null ) {

	$defaults = array( 'style' => 'Main Section' );

	extract( shortcode_atts( $defaults, $atts ) );

	switch($style){
		case "Main Section": $style = "h2"; break;
		case "Sub Section": $style = "h3"; break;
		case "Micro Section / Aside": $style = "h4"; break;
	}

	return "<" . $style . ">" . do_shortcode( $content ) . "</" . $style . ">" . "\n";

}

add_shortcode( 'heading_text', 'des_shortcode_headings' );
...
function des_shortcode_partners ( $atts, $content = null ) {
	...
	if ($title != "" && $title != " "){ $titles_html .= "<div class=\"anyatitle\"><span>".$title."</span>".$pag."</div>"; }
	else { $titles_html .= "<div class=\"anyatitle\">".$pag."</div>"; }
...
function des_i ( $atts, $content = null ) {
	$defaults = array( 'class' => '', 'color' => '', 'font_size' => '40', 'background' => '', 'border' => '', 'style_bg'=>'none', 'a_fffect'=>'', 'align'=>'Left');
	extract( shortcode_atts( $defaults, $atts ) );
	$style = " ";
	if ($color!= "") $style .= "color: ".$color.";";
	if ($font_size!="") $style .= "font-size: ".intval($font_size)."px; width: ".intval($font_size)*2 ."px; height: ".intval($font_size)*2 ."px; line-height: ".intval($font_size)*2 ."px; display:inline-block; ";
	...
	if ($style_bg != "none"){
		...
		if ($style_bg === "circle") $style .= "border-radius:100%;-moz-border-radius:100%;-webkit-border-radius:100%;-ms-border-radius:100%;-o-border-radius:100%;";
...
function des_anyatitle ( $atts, $content = null ) {
	...
	$output = "<h2 class=\"anyatitle $text_align\"><span><span class=\"$classe\" ";
	if ($style!="") $output .= " style=\"".$style."\"";
...
add_shortcode('anyatitle', 'des_anyatitle', 90);
...
function des_spacer_shortcode($atts, $content=null){
	$defaults = array('desktop'=>'','mobile'=>'');
	extract(shortcode_atts($defaults, $atts));
	
	static $spacer = 1;
	
	$desktop = intval($desktop)/2;
	$mobile = intval($mobile)/2;
	
	$output = "<div id=\"spacer-{$spacer}\" class=\"shortcode-spacer\" style=\"margin:{$desktop}px 0px;\"></div>\n";
	if ($mobile) $output .= "<style>@media only screen and (max-width: 765px) {#spacer-{$spacer}{margin:{$mobile}px 0px !important;}}</style>";
	
	$spacer++;
	return $output;
} add_shortcode('spacer','des_spacer_shortcode',90);


function des_pricing_table($atts, $content=null){
	global $wpdb;
	$defaults = array('name'=>'');
	extract(shortcode_atts($defaults, $atts));
	
	$q = "SELECT post_name from ".$wpdb->prefix."posts WHERE post_type LIKE 'rpt_pricing_table' AND post_title LIKE '".$name."'";
	$res = $wpdb->get_results($q, ARRAY_A);
	if ($res[0]) return do_shortcode("[rpt name='".$res[0]['post_name']."']");
	
} add_shortcode('pricing_table', 'des_pricing_table', 90);
