...
*/
        ...
        editor.addButton( 'desthemes_shortcodes_button', {
			...
			menu: [
				{text: 'Spacer', onclick: function() { editor.execCommand( 'des_open_dialog', false, 'spacer', { title: 'Spacer' } ); } },
				...
				{text: 'Title Anya Style', onclick: function() { editor.execCommand( 'des_open_dialog', false, 'title', { title: 'Title Anya Style' } ); } },
				...
				{text: 'Heading Text', onclick: function() { editor.execCommand( 'des_open_dialog', false, 'heading_text', { title: 'Heading Text' } ); } },
