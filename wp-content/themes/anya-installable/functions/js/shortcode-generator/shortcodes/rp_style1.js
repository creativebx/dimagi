	...
	attributes:[
		...
		customMakeShortcode: function(b){
			...
			var g = "[rp_style1 title='" + b.title + "' portfolio='" + b.portfolio + "' total='" + b.total + "' orderby='" + b.order_by + "' order='" + b.order + "' scroller='"+b.rpsOneScroller+"' proj_per_row='" + b.proj_per_row + "' categories='"+b.projectsCategories+"' ";
