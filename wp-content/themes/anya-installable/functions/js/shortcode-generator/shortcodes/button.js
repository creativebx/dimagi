desShortcodeMeta={
	attributes:[
			...
			},
			{
				...
				controlType:"select-control", 
				selectValues:['', 'yellow', 'white', 'black', 'red', 'green', 'orange', 'blue', 'violet', 'greenanya'],
				defaultValue: '', 
			...
			customMakeShortcode: function(b){
				...
				var border_out = "";
				if(b.color != "" ){
					if(b.color == 'yellow' || b.color == 'white' || b.color == 'black' || b.color == 'red' || b.color == 'green' || b.color == 'orange' || b.color == 'blue' || b.color == 'violet' || b.color == 'greenanya'){
						...
						if ( b.border )
				   		...
				   		if(border_out && b.color != "greenanya") 
				...
				if(b.color == 'yellow' || b.color == 'white' || b.color == 'black' || b.color == 'red' || b.color == 'green' || b.color == 'orange' || b.color == 'blue' || b.color == 'violet' || b.color == 'greenanya') color_output="";
