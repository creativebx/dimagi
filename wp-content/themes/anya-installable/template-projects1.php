					...
					<article id="projects-1" <?php post_class(); ?> role="article">
						...
						<div class="entry-content project_list_s2">
							...
							<div class="moreinfo_text sixteen columns">
								...
								<div class="filterby">
									<div class="filterby_btn <?php if (get_option(DESIGNARE_SHORTNAME."_enable_open_close_categories") === "on"){ if (get_option(DESIGNARE_SHORTNAME."_categories_initial_state") === "closed"){ echo "closed"; }} ?>" <?php if (get_option(DESIGNARE_SHORTNAME."_enable_open_close_categories") === "on") { ?> onclick="toggleFilter($(this));" <?php } ?>><?php echo __(get_option(DESIGNARE_SHORTNAME."_filter_by"), "anya"); ?><div class="arrow-right"></div></div>
