			...
			<div id="post-0" class="post error404 not-found" role="article">
				<header class="entry-header">
					<div class="error-c">
						...
						<p class="text-error"><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching one of the links in the right sidebar or in the top menu, can help.', 'anya' ); ?></p>
					</div>
