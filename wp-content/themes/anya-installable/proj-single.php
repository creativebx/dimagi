<?php get_header(); 
global $anya_thisPostID; $anya_thisPostID = get_the_ID(); ?>
<div class="fullwidth-container <?php echo $anya_thisPostID; ?>" style="
	    	...
	    	?>
				<div class="container">
			    	...
			    	?>"><?php echo get_the_title($anya_thisPostID); ?></h1>
		    		<?php
	...
	<?php }
		...
		$anya_custom = get_post_meta($anya_thisPostID, 'des_custom_page_style_value', true);
		$singleLayout = get_post_meta($anya_thisPostID, 'singleLayout_value', true);
		if ($singleLayout == "default"){
			$singleLayout = get_option(DESIGNARE_SHORTNAME."_single_layout");
		}

		if (get_post_meta($anya_thisPostID, "portfolioType_value", true) != "other") {
			switch($singleLayout){
				case "left_slider":
					?>					
												...
												<div class="proj-content <?php echo get_the_ID(); ?>">
													<div class="projects_description">
														<div class="projects_media eleven columns leftSlider">
															<?php
																if (get_post_meta($anya_thisPostID, "portfolioType_value", true) == "image"){
																	echo "<div id='p-slider-".get_the_ID()."' class='flexslider clearfix'><ul class='slides da-thumbs-plus'>";
																	
																	$sliderData = get_post_meta($anya_thisPostID, "sliderImages_value", true);
																...
																if (get_post_meta($anya_thisPostID, "portfolioType_value", true) == "video") {
																	echo "<div id='the_movies'></div>";
																	$videosType = get_post_meta($anya_thisPostID, "videoSource_value", true);
																	if ($videosType != "embed"){
																		$videos = get_post_meta($anya_thisPostID, "videoCode_value", true);
																		$videos = preg_replace( '/\s+/', '', $videos );
																		$vid = explode(",",$videos);
																	}
																	switch (get_post_meta($anya_thisPostID, "videoSource_value", true)){
																		case "youtube":
																			foreach ($vid as $v){
																		...
																		case "vimeo":
																			...
																			break;
																		case "embed":
																			echo "<div class='embedded'>".get_post_meta($anya_thisPostID, "videoCode_value", true)."</div>";
																			break;
																	}
																}
															?>
												...
												<script type="text/javascript">
													...
													<?php
														if(get_post_meta($anya_thisPostID, "portfolioType_value", true) == "image"){ 
															...
															if (get_post_meta($anya_thisPostID, "custom_slider_opts_value", true) == "on"){
																$animation = get_post_meta($anya_thisPostID, "projs_flex_transition_value", true);
																$directionNav = get_post_meta($anya_thisPostID, "projs_flex_navigation_value", true);
																$slideshowSpeed = get_post_meta($anya_thisPostID, "projs_flex_slide_duration_value", true);
																$pauseOnHover = get_post_meta($anya_thisPostID, "projs_flex_pause_hover_value", true);
																$controlNav = get_post_meta($anya_thisPostID, "projs_flex_controls_value", true);
																$slideshow = get_post_meta($anya_thisPostID, "projs_flex_autoplay_value", true);
																$height = get_post_meta($anya_thisPostID, "projs_flex_height_value", true);
																$animationDuration = get_post_meta($anya_thisPostID, "projs_flex_transition_duration_value", true);
															} else {
														...
														if ($("#p-slider-<?php echo $anya_thisPostID; ?>").find('li').length > 1){
															$("#p-slider-<?php echo $anya_thisPostID; ?>").flexslider({
																animation: '<?php echo $animation; ?>',
																slideDirection: "horizontal", 
																directionNav: '<?php echo $directionNav; ?>',
																slideshowSpeed: <?php echo $slideshowSpeed; ?>,
																controlsContainer: "#p-slider-<?php echo $anya_thisPostID; ?> .flex-container",
																pauseOnAction: false,
															...
															$("#p-slider-<?php echo $anya_thisPostID; ?>").css('max-height','<?php echo $height ?>');
									
														} else {
																$("#p-slider-<?php echo $anya_thisPostID; ?>").find('ul li').css('display','block');
																$("#p-slider-<?php echo $anya_thisPostID; ?>").find('li a img').css('opacity',1);
																$("#p-slider-<?php echo $anya_thisPostID; ?>").find('.magnifier').bind('click', function(){
																$("#p-slider-<?php echo $anya_thisPostID; ?>").find('li a').trigger('click');
															});
														}
													...
													<?php } if (get_post_meta($anya_thisPostID, "portfolioType_value", true) == "video") {
														
														if (get_post_meta($anya_thisPostID, "videoSource_value", true) != "embed"){ 
															?>
