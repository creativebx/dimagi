...
if(get_the_post_thumbnail()) {
	$featuredImage = cfi_featured_image_url( array( 'size' => 'full' ) );
	$style = "background:url('" . $featuredImage . "') no-repeat center center / cover !important;";
			...
			<div class="container">
					...
					<div class="pageTitle sixteen columns" <?php if ($margintop != "") echo " style='margin-bottom: ".$margintop.";margin-top: ".$margintop.";'"; ?>>
		    			<h1 class="page_title" style="<?php 
							...
							echo "color: #$tcolor; font-size: $tsize;".$headerFontSize.$tshadow;
			...
			<?php
			    ...
			    while ( have_posts() ) : 
			    	...
			    	the_post();	 ?>
				    	...
				    	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php if ($sidebar == "left") echo "style='float:right;'"; ?>>
					    	...
					    	<div class="postcontent" style="<?php if ($sidebar == "left") echo "margin-right:0px;"; else echo ""; ?>">
