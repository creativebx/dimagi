...
?>
		...
		<section id="primary" role="region" class="blogarchive sixteen columns" style="margin-left:3%;">
			<div id="content">
				...
				<?php
				    ...
				    if ($the_query->have_posts()){ ?>
				    	...
				    	<div class="post-listing container" style="border-right: none !important;width: 100%;">
						    ...
						    while ( $the_query->have_posts() ) : 
						    	...
						    	$the_query->the_post();	 ?>
							    	...
							    	<article id="post-<?php the_ID(); ?>" class="post <?php post_class(); ?>">
								    	...
								    	<div id="blog-fullWidth" class="postcontent sixteen columns">
								    ...
								    ?>
									    ...
									    <div id="divider-bfw" class="des-sc-dots-divider sixteen columns"></div>
